...
A: Semantic HTML introduces the meaning to the content.


2. Name two big differences between ```display: block;``` and ```display: inline;```.

A: inline elements don't force a new line, block elements start a new line.

    inline-block allows to set a width and height on the element. 
   inline, top and bottom margins & paddings are not respected
...
A: Git provides functionality, security and flexibility that most developers and team, which is a great working emvironment for developers.
